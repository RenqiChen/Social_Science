        ...
        for epoch in range(epochs):
            ...
            for leader_index in range(len(self.team_pool)):
                for team_index in range(len(self.team_pool[leader_index])):
                    ...
                    action = self.action_excution(self.team_pool[leader_index][team_index].state, epoch)
                    if action is not None:
                        self.team_pool[leader_index][team_index] = action(self.team_pool[leader_index][team_index])
